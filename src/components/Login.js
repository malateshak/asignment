...
class Login extends Component {
  ...
  onClickLogIn = (e) => {
    ...
    username !== 'hruday@gmail.com' && password !== 'hruday123' ? (this.setState({ error: true, errorMsg: 'Invalid Username and Password'}) ) :
    username !== 'hruday@gmail.com' ? (this.setState({error: true, errorMsg: 'Invalid Username'}) ) :
    password !== 'hruday123' ? (this.setState({error: true, errorMsg: 'Invalid Password'}) ) :
    (this.login());
